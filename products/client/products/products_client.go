...
type ClientService interface {
	...
	StoreProduct(params *StoreProductParams) (*StoreProductOK, error)
...
/*
  DeleteProduct Delete a products by id
*/
...
*/
func (a *Client) StoreProduct(params *StoreProductParams) (*StoreProductOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewStoreProductParams()
	}
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &StoreProductReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*StoreProductOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for storeProduct: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
